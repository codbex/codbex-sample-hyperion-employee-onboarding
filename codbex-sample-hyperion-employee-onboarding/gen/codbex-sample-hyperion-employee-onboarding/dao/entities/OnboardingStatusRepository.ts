...
export class OnboardingStatusRepository {
    ...
    constructor(dataSource = "DefaultDB") {
        this.dao = daoApi.create(OnboardingStatusRepository.DEFINITION, null, dataSource);
    }
    ...
    private async triggerEvent(data: OnboardingStatusEntityEvent | OnboardingStatusUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-sample-hyperion-employee-onboarding-entities-OnboardingStatus", ["trigger"]);
        ...
        producer.topic("codbex-sample-hyperion-employee-onboarding-entities-OnboardingStatus").send(JSON.stringify(data));
    }
}
