...
export class DepartmentRepository {
    ...
    private async triggerEvent(data: DepartmentEntityEvent | DepartmentUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-sample-hyperion-employee-onboarding-Department-Department", ["trigger"]);
        ...
        producer.topic("codbex-sample-hyperion-employee-onboarding-Department-Department").send(JSON.stringify(data));
    }
}
